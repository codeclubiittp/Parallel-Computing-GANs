...
namespace fox {
    ...
    void convolution2D(cudnnHandle_t& handle, std::vector<double>& image, std::vector<double>& filters,
        ...
        CUDNN_CHECK(cudnnSetTensor4dDescriptor(inputDescriptor, CUDNN_TENSOR_NCHW, CUDNN_DATA_DOUBLE, 1,
            imageInfo.channels, imageInfo.height, imageInfo.width));
        CUDNN_CHECK(cudnnSetFilter4dDescriptor(filterDescriptor, CUDNN_DATA_DOUBLE, CUDNN_TENSOR_NCHW, filtersInfo.n,
            imageInfo.channels, filtersInfo.height, filtersInfo.width));
        CUDNN_CHECK(cudnnSetConvolution2dDescriptor(convolutionDescriptor, 0, 0, 1, 1, 1, 1,
        ...
        CUDNN_CHECK(cudnnSetTensor4dDescriptor(outputDescriptor, CUDNN_TENSOR_NCHW, CUDNN_DATA_DOUBLE, 1,
        ...
        CUDNN_CHECK(cudnnConvolutionForward(handle, &alpha, inputDescriptor, dimage, filterDescriptor, dfilters,
            convolutionDescriptor, CUDNN_CONVOLUTION_FWD_ALGO_IMPLICIT_GEMM, nullptr, 0, &beta,
            outputDescriptor, doutputImage));
    ...
    */
    void convolution2DGraphFE(cudnnHandle_t& handle, std::vector<double>& image, std::vector<double>& filters,
        ...
        inputTensorAttributes->set_dim({ 1LL, (int64_t)imageInfo.channels, (int64_t)imageInfo.height, (int64_t)imageInfo.width });
        ...
        filterTensorAttributes->set_dim({ 1LL, (int64_t)filtersInfo.n, (int64_t)imageInfo.channels,
            (int64_t)filtersInfo.height,(int64_t)filtersInfo.width });
        ...
        std::unordered_map<int64_t, void*> variantPack = {
            {inputTensorAttributes->get_uid(), dimage},
    ...
    void convolution2DGraph(cudnnHandle_t& handle, std::vector<double>& image, std::vector<double>& filters,
        std::vector<double>& output, imageInfo2D& imageInfo, filtersInfo2D& filtersInfo) {
        ...
        CUDNN_CHECK(cudnnBackendSetAttribute(filterDescriptor, CUDNN_ATTR_TENSOR_BYTE_ALIGNMENT,
            CUDNN_TYPE_INT64, 1, &filterAlignment));
        ...
        CUDNN_CHECK(cudnnBackendSetAttribute(outputDescriptor, CUDNN_ATTR_TENSOR_DATA_TYPE, 
            CUDNN_TYPE_DATA_TYPE, 1, &outputDataType));
        ...
        CUDNN_CHECK(cudnnBackendSetAttribute(outputDescriptor, CUDNN_ATTR_TENSOR_BYTE_ALIGNMENT,
            CUDNN_TYPE_INT64, 1, &outputAlignment));
        ...
        CUDNN_CHECK(cudnnBackendSetAttribute(convOpDescriptor, CUDNN_ATTR_CONVOLUTION_CONV_MODE,
            CUDNN_TYPE_CONVOLUTION_MODE, 1, &convMode));
        ...
        CUDNN_CHECK(cudnnBackendCreateDescriptor(CUDNN_BACKEND_OPERATION_CONVOLUTION_FORWARD_DESCRIPTOR, 
            &convForwardDescriptor));

        double alpha = 1.0;
        double beta = 0.0;

        CUDNN_CHECK(cudnnBackendSetAttribute(convForwardDescriptor, CUDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_X,
            CUDNN_TYPE_BACKEND_DESCRIPTOR, 1, &xDescriptor));
        CUDNN_CHECK(cudnnBackendSetAttribute(convForwardDescriptor, CUDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_W,
            CUDNN_TYPE_BACKEND_DESCRIPTOR, 1, &filterDescriptor));
        CUDNN_CHECK(cudnnBackendSetAttribute(convForwardDescriptor, CUDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_Y,
            CUDNN_TYPE_BACKEND_DESCRIPTOR, 1, &outputDescriptor));
        CUDNN_CHECK(cudnnBackendSetAttribute(convForwardDescriptor, CUDNN_ATTR_OPERATION_CONVOLUTION_FORWARD_CONV_DESC,
            CUDNN_TYPE_BACKEND_DESCRIPTOR, 1, &convOpDescriptor));
        ...
        CUDNN_CHECK(cudnnBackendSetAttribute(opGraph, CUDNN_ATTR_OPERATIONGRAPH_OPS,
            CUDNN_TYPE_BACKEND_DESCRIPTOR, 1, &convForwardDescriptor));
        CUDNN_CHECK(cudnnBackendSetAttribute(opGraph, CUDNN_ATTR_OPERATIONGRAPH_HANDLE,
        ...
        CUDNN_CHECK(cudnnBackendSetAttribute(engineDescriptor, CUDNN_ATTR_ENGINE_OPERATION_GRAPH, 
            CUDNN_TYPE_BACKEND_DESCRIPTOR, 1, &opGraph));
        CUDNN_CHECK(cudnnBackendSetAttribute(engineDescriptor, CUDNN_ATTR_ENGINE_GLOBAL_INDEX, 
            CUDNN_TYPE_INT64, 1, &globalIndex));
        ...
        CUDNN_CHECK(cudnnBackendSetAttribute(engineConfigDescriptor, CUDNN_ATTR_ENGINECFG_ENGINE, 
            CUDNN_TYPE_BACKEND_DESCRIPTOR, 1, &engineDescriptor));
        CUDNN_CHECK(cudnnBackendFinalize(engineConfigDescriptor));

        int64_t engineWorkspaceSize;
        
        CUDNN_CHECK(cudnnBackendGetAttribute(engineConfigDescriptor, CUDNN_ATTR_ENGINECFG_WORKSPACE_SIZE, 
            CUDNN_TYPE_INT64, 1, NULL, &engineWorkspaceSize));
        ...
        CUDNN_CHECK(cudnnBackendSetAttribute(planDescriptor, CUDNN_ATTR_EXECUTION_PLAN_HANDLE, 
            CUDNN_TYPE_HANDLE, 1, &handle));
        CUDNN_CHECK(cudnnBackendSetAttribute(planDescriptor, CUDNN_ATTR_EXECUTION_PLAN_ENGINE_CONFIG, 
            CUDNN_TYPE_BACKEND_DESCRIPTOR, 1, &engineConfigDescriptor));
        CUDNN_CHECK(cudnnBackendFinalize(planDescriptor));

        int64_t planWorkspaceSize;
        CUDNN_CHECK(cudnnBackendGetAttribute(planDescriptor, CUDNN_ATTR_EXECUTION_PLAN_WORKSPACE_SIZE, 
            CUDNN_TYPE_INT64, 1, NULL, &planWorkspaceSize));
        ...
        CUDNN_CHECK(cudnnBackendSetAttribute(varpackDescriptor, CUDNN_ATTR_VARIANT_PACK_DATA_POINTERS, 
            CUDNN_TYPE_VOID_PTR, 3, pDevice));
        CUDNN_CHECK(cudnnBackendSetAttribute(varpackDescriptor, CUDNN_ATTR_VARIANT_PACK_UNIQUE_IDS, 
            CUDNN_TYPE_INT64, 3, uids));
        CUDNN_CHECK(cudnnBackendSetAttribute(varpackDescriptor, CUDNN_ATTR_VARIANT_PACK_WORKSPACE, 
